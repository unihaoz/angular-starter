...
describe('BigInputActionComponent', () => {
  ...
  it('should be created', () => {
    const template = '<uh-big-input-action></uh-big-input-action>';
  ...
  it('should disable button if disabled property is set', () => {
    const template =
      '<uh-big-input-action [disabled]="true"></uh-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should display icon if fontSet and fontIcon properties are set', () => {
    const template =
      '<uh-big-input-action fontSet="fas" fontIcon="trash"></uh-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should display label with provided text when label property is set', () => {
    const template =
      '<uh-big-input-action label="delete"></uh-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should emit action event on button click', () => {
    const template =
      '<uh-big-input-action (action)="actionHandler()"></uh-big-input-action>';
    fixture = createHostComponent(template);
